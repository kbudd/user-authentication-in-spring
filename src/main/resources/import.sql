...
-- Insert two users
insert into role (username, enabled, password, role_id) values ('user',true,'password',1)
insert into role (username, enabled, password, role_id) values ('kbudd',true,'password',1)
